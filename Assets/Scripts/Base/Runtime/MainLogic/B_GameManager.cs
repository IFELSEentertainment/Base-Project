...
namespace Base {
    ...
    public class B_GameManager : B_ManagerBase {
        ...
        public B_SaveSystemEditor bSave;
        ...
        public override Task ManagerStrapping() {
            ...
            bSave = new B_SaveSystemEditor();
            B_GUIManager.GetButton(Enum_Menu_MainComponent.BTN_Start).AddFunction(StartGame);
            B_GUIManager.GetButton(Enum_Menu_GameOverComponent.BTN_Sucess).AddFunction(EndLevel);
            B_GUIManager.GetButton(Enum_Menu_GameOverComponent.BTN_Fail).AddFunction(RestartLevel);
            if (ActivateRuntimeEditor) {
                _runtimeEditor = new RuntimeEditor();
                _runtimeEditor.Setup();
            }
        ...
        private void RestartLevel() {
            ...
            B_LevelManager.instance.ReloadCurrentLevel();
        ...
        private void EndLevel() {
            ...
            B_LevelManager.instance.LoadInNextLevel();
        }
        ...
        public class RuntimeEditor {
            ...
            public void OnGUI() {
                if (open) {
                    ...
                    //     B_GameManager.instance.CurrentGameState = GameStates.Playing;
                    //     gameStat = "ON PLAYING";
                    // }
                    //
                    // if (GUI.Button(new Rect(450, 175, 200, 50), "On Pause", myButtonStyle)) {
                    //     B_GameManager.instance.CurrentGameState = GameStates.Paused;
                    //     gameStat = "ON PAUSE";
                    // }
                    //
                    // if (GUI.Button(new Rect(675, 175, 200, 50), "On Init", myButtonStyle)) {
                    //     B_GameManager.instance.CurrentGameState = GameStates.Init;
                    //     gameStat = "ON INIT";
                    // }
                    //
                    // if (GUI.Button(new Rect(900, 175, 200, 50), "On End", myButtonStyle)) {
                    //     B_GameManager.instance.CurrentGameState = GameStates.End;
                    //     gameStat = "ON END";
                    // }
